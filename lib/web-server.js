...
async function setupDev(app, webpackConfig, indexReference) {
  ...
  compiler.hooks.done.tap('WebServerIndex', () => {
    ...
    indexReference.content = devMiddleware.fileSystem.readFileSync(path.join(webpackConfig.output.path, 'index.html'));
  });
}
